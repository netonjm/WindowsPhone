namespace Microsoft.WPSync.UI.ViewModels
{
    ...
    public class DeviceItemViewModel : PropChangeNotifier
    {
        ...
        private static string MakeLocationString(int? storageLocation)
        {
            ...
            ZMEDIALIB_STORAGELOCATION_FLAG zmedialib_storagelocation_flag = (ZMEDIALIB_STORAGELOCATION_FLAG)storageLocation.Value;
            if (zmedialib_storagelocation_flag <= ZMEDIALIB_STORAGELOCATION_FLAG.ZMEDIALIB_STORAGELOCATION_FLAG_EXTERNAL_1)
            {
                switch (zmedialib_storagelocation_flag)
                {
            ...
            if ((zmedialib_storagelocation_flag != ZMEDIALIB_STORAGELOCATION_FLAG.ZMEDIALIB_STORAGELOCATION_FLAG_EXTERNAL_2) && (zmedialib_storagelocation_flag != ZMEDIALIB_STORAGELOCATION_FLAG.ZMEDIALIB_STORAGELOCATION_FLAG_EXTERNAL_3))
            {
                goto Label_0051;
            }
        Label_004B:
