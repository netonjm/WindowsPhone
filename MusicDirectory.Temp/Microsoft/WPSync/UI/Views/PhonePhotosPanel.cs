namespace Microsoft.WPSync.UI.Views
{
    ...
    public class PhonePhotosPanel : UserControl, IComponentConnector
    {
        ...
        public void InitializeComponent()
        {
            if (!this._contentLoaded)
            {
                ...
                Uri resourceLocator = new Uri("/WindowsPhone;V0.9.0.0;component/views/phonephotospanel.xaml", UriKind.Relative);
