namespace Microsoft.WPSync.UI.ViewModels
{
    ...
    public class PodcastEpisodeRuleViewModel : PropChangeNotifier
    {
        ...
        private static readonly List<PodcastsSelectionItem> DefaultEpisodeRules = new List<PodcastsSelectionItem> { new PodcastsSelectionItem(Resources.AllEpisodesText, 0, 0x7fffffff), new PodcastsSelectionItem(Resources.Recent1EpisodeText, 0, 1), new PodcastsSelectionItem(Resources.Recent3EpisodeText, 0, 3), new PodcastsSelectionItem(Resources.Recent5EpisodeText, 0, 5), new PodcastsSelectionItem(Resources.AllUnplayedText, 1, 0x7fffffff), new PodcastsSelectionItem(Resources.Unplayed1Text, 1, 1), new PodcastsSelectionItem(Resources.Unplayed3Text, 1, 3), new PodcastsSelectionItem(Resources.Unplayed5Text, 1, 5) };
