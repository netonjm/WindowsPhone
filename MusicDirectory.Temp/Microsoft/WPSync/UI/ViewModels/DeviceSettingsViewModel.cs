namespace Microsoft.WPSync.UI.ViewModels
{
    ...
    public class DeviceSettingsViewModel : PropChangeNotifier, ISettingsViewModel
    {
        ...
        {
            if (MessageBox.Show(Microsoft.WPSync.UI.Properties.Resources.EraseContentWarningText, Microsoft.WPSync.UI.Properties.Resources.EraseContentWarningTitle, MessageBoxButton.YesNo, MessageBoxImage.Exclamation, MessageBoxResult.No) == MessageBoxResult.Yes)
            {
        ...
        public bool Validate()
        {
            ...
            {
                Errors.ShowError(Microsoft.WPSync.UI.Properties.Resources.MissingValueText, new object[0]);
                return false;
            }
            return true;
        }
