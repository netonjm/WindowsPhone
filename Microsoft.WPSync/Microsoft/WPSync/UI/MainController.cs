...
namespace Microsoft.WPSync.UI
{
    ...
    public class MainController : PropChangeNotifier, IMainController, INotifyPropertyChanged, IPartnershipClient
    {
        ...
        {
            return (((ZmdbSyncSource) this.CurrentSyncPartnership.Engine.Targets.First<ISyncSource>()).StorageCardHasChanged() && (MessageBox.Show(Resources.StorageCardHasChanged, Resources.ApplicationTitle, MessageBoxButton.OKCancel) == MessageBoxResult.Cancel));
        }
